...
public extension BinaryInteger {
    #if canImport(CoreGraphics)
    /// Shorthand conversion from some Integer to or from CGFloat
    var cg: CGFloat { get { CGFloat(self) } set(v) { self = Self(v) } }
    #endif
    /// Shorthand conversion from some Integer to or from Float
    var f: Float { get { Float(self) } set(v) { self = Self(v) } }
    /// Shorthand conversion from some Integer to or from Double
    var d: Double { get { Double(self) } set(v) { self = Self(v) } }
    /// Shorthand conversion from some Integer to or from Int
    var int: Int { get { Int(self) } set(v) { self = Self(v) } }
}
